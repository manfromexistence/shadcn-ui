...
export const generatedPresets = {
  "modern-minimal": {
    ...
    radius: "0.375rem",
    fonts: {
      sans: sansFonts.Inter.value,
      serif: serifFonts['Source Serif 4'].value,
    ...
    light: {
      ...
      "sidebar-ring": "#3b82f6",
      "font-sans": sansFonts.Inter.value,
      "font-serif": serifFonts['Source Serif 4'].value,
      "font-mono": monoFonts['JetBrains Mono'].value
    },
    dark: {
      background: "#171717",
      foreground: "#e5e5e5",
