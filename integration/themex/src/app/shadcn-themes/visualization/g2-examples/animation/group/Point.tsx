...
function* insertionSort(arr) {
  ...
  useEffect(() => {
    ...
    chartRef.current = new Chart({
      ...
      transform: [{"type":"/* PARSE_ERROR */","comment":"/* TODO: Manually convert transform options: {\n    type: 'stackEnter',\n    groupBy: ['x', 'y'],\n    orderBy: 'color',\n    duration: 2000,\n  } */"}],
      scale: {"y":{"range":[0,1]},"color":{"comment":"/* TODO: Manually convert scale options: {\n    type: 'sqrt',\n    range: ['hsl(152,80%,80%)', 'hsl(228,30%,40%)'],\n    interpolate: interpolateHcl,\n  } */"}},
      legend: {"color":false},
      style: {"plotFill":"#000","text":"United States, 1950s","x":"50%","y":"50%","textAlign":"center","fontSize":"/* TODO: Convert style value/expression: 18 */","fill":"#666","dy":"30"},
    });
