...
/*
Original Dumi Example Code from: ../../G2/site/examples/theme/theme/demo/academy.ts
--------------------------------------------------------------------------------
// /**
...
const ThemeThemeAcademyChart: React.FC = () => {
...
export default ThemeThemeAcademyChart;
