...
/*
Original Dumi Example Code from: ../../G2/site/examples/annotation/connector/demo/revenue-flow-waterfall.ts
--------------------------------------------------------------------------------
// /**
...
const AnnotationConnectorRevenueFlowWaterfallChart: React.FC = () => {
  ...
  return (
     <div>
        ...
        <h2 className="text-xl font-semibold mb-2">Revenue flow waterfall</h2>
