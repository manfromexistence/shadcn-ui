...
/*
Original Dumi Example Code from: ../../G2/site/examples/general/line/demo/line-area-clip-path.ts
--------------------------------------------------------------------------------
...
const GeneralLineLineAreaClipPathChart: React.FC = () => {
  ...
  return (
     <div>
        ...
        <h2 className="text-xl font-semibold mb-2">Line area clip path</h2>
...
export default GeneralLineLineAreaClipPathChart;
