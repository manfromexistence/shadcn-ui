...
/*
Original Dumi Example Code from: ../../G2/site/examples/general/link/demo/link-annotation.ts
--------------------------------------------------------------------------------
// /**
...
const GeneralLinkLinkAnnotationChart: React.FC = () => {
  ...
  return (
     <div>
        ...
        <h2 className="text-xl font-semibold mb-2">Link annotation</h2>
...
export default GeneralLinkLinkAnnotationChart;
