...
/*
Original Dumi Example Code from: ../../G2/site/examples/general/dual/demo/dual-axis-stacked-group-bar.ts
--------------------------------------------------------------------------------
...
const GeneralDualDualAxisStackedGroupBarChart: React.FC = () => {
  ...
  return (
     <div>
        ...
        <h2 className="text-xl font-semibold mb-2">Dual axis stacked group bar</h2>
