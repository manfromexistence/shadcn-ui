...
/*
Original Dumi Example Code from: ../../G2/site/examples/general/line/demo/line-gradient-encoding.ts
--------------------------------------------------------------------------------
// /**
...
const GeneralLineLineGradientEncodingChart: React.FC = () => {
  ...
  return (
     <div>
        ...
        <h2 className="text-xl font-semibold mb-2">Line gradient encoding</h2>
