...
/*
Original Dumi Example Code from: ../../G2/site/examples/general/interval/demo/bar-stacked-diverging-rounded.ts
--------------------------------------------------------------------------------
// /**
...
const GeneralIntervalBarStackedDivergingRoundedChart: React.FC = () => {
  ...
  return (
     <div>
        ...
        <h2 className="text-xl font-semibold mb-2">Bar stacked diverging rounded</h2>
