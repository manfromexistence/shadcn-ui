...
/*
Original Dumi Example Code from: ../../G2/site/examples/general/interval/demo/bar-fixed-cornered.ts
--------------------------------------------------------------------------------
...
const GeneralIntervalBarFixedCorneredChart: React.FC = () => {
  ...
  return (
     <div>
        ...
        <h2 className="text-xl font-semibold mb-2">Bar fixed cornered</h2>
