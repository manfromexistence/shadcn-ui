...
/*
Original Dumi Example Code from: ../../G2/site/examples/general/histogram/demo/histogram-binwidth.ts
--------------------------------------------------------------------------------
...
const GeneralHistogramHistogramBinwidthChart: React.FC = () => {
  ...
  return (
     <div>
        ...
        <h2 className="text-xl font-semibold mb-2">Histogram binwidth</h2>
