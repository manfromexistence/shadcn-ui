...
function* insertionSort(arr) {
  ...
  useEffect(() => {
    ...
    chartRef.current = new Chart({
      ...
      style: {"stroke":"white","inset":"/* TODO: Convert style value/expression: 1 */","radius":"/* TODO: Convert style value/expression: 10 */"},
      labels: [{"comment":"/* TODO: Manually convert label options: { text: 'name', fontSize: 10, fontWeight: 'bold' } */"},{"comment":"/* TODO: Manually convert label options: {\n    text: (d, i, data) => (i < data.length - 3 ? d.value : ''),\n    fontSize: 9,\n    dy: 12,\n  } */"}],
