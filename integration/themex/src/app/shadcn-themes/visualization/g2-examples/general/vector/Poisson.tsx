...
/*
Original Dumi Example Code from: ../../G2/site/examples/general/vector/demo/poisson.ts
--------------------------------------------------------------------------------
...
const GeneralVectorPoissonChart: React.FC = () => {
  ...
  return (
     <div>
        ...
        <h2 className="text-xl font-semibold mb-2">Poisson</h2>
...
export default GeneralVectorPoissonChart;
