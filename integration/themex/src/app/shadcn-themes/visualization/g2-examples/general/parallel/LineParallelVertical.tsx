...
/*
Original Dumi Example Code from: ../../G2/site/examples/general/parallel/demo/line-parallel-vertical.ts
--------------------------------------------------------------------------------
// /**
...
const GeneralParallelLineParallelVerticalChart: React.FC = () => {
  ...
  return (
     <div>
        ...
        <h2 className="text-xl font-semibold mb-2">Line parallel vertical</h2>
