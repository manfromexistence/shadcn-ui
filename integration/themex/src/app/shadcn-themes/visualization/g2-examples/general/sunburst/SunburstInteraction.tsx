...
/*
Original Dumi Example Code from: ../../G2/site/examples/general/sunburst/demo/sunburst-interaction.ts
--------------------------------------------------------------------------------
...
const GeneralSunburstSunburstInteractionChart: React.FC = () => {
  ...
  return (
     <div>
        ...
        <h2 className="text-xl font-semibold mb-2">Sunburst interaction</h2>
