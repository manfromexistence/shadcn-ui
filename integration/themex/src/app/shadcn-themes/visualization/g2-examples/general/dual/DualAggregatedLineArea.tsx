...
/*
Original Dumi Example Code from: ../../G2/site/examples/general/dual/demo/dual-aggregated-line-area.ts
--------------------------------------------------------------------------------
// /**
...
const GeneralDualDualAggregatedLineAreaChart: React.FC = () => {
  ...
  return (
     <div>
        ...
        <h2 className="text-xl font-semibold mb-2">Dual aggregated line area</h2>
