...
/*
Original Dumi Example Code from: ../../G2/site/examples/general/dual/demo/dual-axis-multi-line-bar.ts
--------------------------------------------------------------------------------
...
const GeneralDualDualAxisMultiLineBarChart: React.FC = () => {
  ...
  return (
     <div>
        ...
        <h2 className="text-xl font-semibold mb-2">Dual axis multi line bar</h2>
