...
/*
Original Dumi Example Code from: ../../G2/site/examples/general/image/demo/contributor.ts
--------------------------------------------------------------------------------
...
const GeneralImageContributorChart: React.FC = () => {
...
export default GeneralImageContributorChart;
