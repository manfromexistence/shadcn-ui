...
/*
Original Dumi Example Code from: ../../G2/site/examples/general/line/demo/line-aggregated-label.ts
--------------------------------------------------------------------------------
// /**
...
const GeneralLineLineAggregatedLabelChart: React.FC = () => {
  ...
  return (
     <div>
        ...
        <h2 className="text-xl font-semibold mb-2">Line aggregated label</h2>
