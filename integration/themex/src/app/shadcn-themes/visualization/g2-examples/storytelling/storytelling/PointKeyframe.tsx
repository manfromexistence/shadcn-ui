...
/*
Original Dumi Example Code from: ../../G2/site/examples/storytelling/storytelling/demo/point-keyframe.ts
--------------------------------------------------------------------------------
...
const StorytellingStorytellingPointKeyframeChart: React.FC = () => {
  ...
  return (
     <div>
        ...
        <h2 className="text-xl font-semibold mb-2">Point keyframe</h2>
