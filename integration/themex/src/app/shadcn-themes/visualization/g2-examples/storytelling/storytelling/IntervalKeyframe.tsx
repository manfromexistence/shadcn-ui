...
/*
Original Dumi Example Code from: ../../G2/site/examples/storytelling/storytelling/demo/interval-keyframe.ts
--------------------------------------------------------------------------------
...
const StorytellingStorytellingIntervalKeyframeChart: React.FC = () => {
  ...
  return (
     <div>
        ...
        <h2 className="text-xl font-semibold mb-2">Interval keyframe</h2>
