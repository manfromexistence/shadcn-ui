...
/*
Original Dumi Example Code from: ../../G2/site/examples/component/tooltip/demo/tooltip-crosshairs.ts
--------------------------------------------------------------------------------
...
const ComponentTooltipTooltipCrosshairsChart: React.FC = () => {
  ...
  return (
     <div>
        ...
        <h2 className="text-xl font-semibold mb-2">Tooltip crosshairs</h2>
