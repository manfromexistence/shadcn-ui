...
/*
Original Dumi Example Code from: ../../G2/site/examples/component/tooltip/demo/tooltip-click-line.ts
--------------------------------------------------------------------------------
...
const ComponentTooltipTooltipClickLineChart: React.FC = () => {
  ...
  return (
     <div>
        ...
        <h2 className="text-xl font-semibold mb-2">Tooltip click line</h2>
