...
/*
Original Dumi Example Code from: ../../G2/site/examples/analysis/group/demo/bar-aggregated-normalized-stacked.ts
--------------------------------------------------------------------------------
// /**
...
const AnalysisGroupBarAggregatedNormalizedStackedChart: React.FC = () => {
  ...
  return (
     <div>
        ...
        <h2 className="text-xl font-semibold mb-2">Bar aggregated normalized stacked</h2>
