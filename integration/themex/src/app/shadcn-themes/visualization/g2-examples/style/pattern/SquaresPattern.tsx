...
/*
Original Dumi Example Code from: ../../G2/site/examples/style/pattern/demo/squares-pattern.ts
--------------------------------------------------------------------------------
// /**
...
const StylePatternSquaresPatternChart: React.FC = () => {
...
export default StylePatternSquaresPatternChart;
