...
/*
  ...
  Source: ../../G2/site/examples/style/theme/demo/dark.ts
  ================================================================================
  // /**
...
const StyleThemeDarkChart: React.FC = () => {
...
function* insertionSort(arr) {
  ...
  useEffect(() => {
    ...
    chartRef.current = new Chart({
      ...
      transform: [{"type":"stackY"}],
      style: {"radius":"/* TODO: Convert style value/expression: 4 */","inset":"/* TODO: Convert style value/expression: 1 */"},
...
export default StyleThemeDarkChart;
