...
/*
Original Dumi Example Code from: ../../G2/site/examples/style/theme/demo/academy.ts
--------------------------------------------------------------------------------
// /**
...
const StyleThemeAcademyChart: React.FC = () => {
...
export default StyleThemeAcademyChart;
