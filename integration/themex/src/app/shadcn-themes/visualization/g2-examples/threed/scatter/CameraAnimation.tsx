...
/*
Original Dumi Example Code from: ../../G2/site/examples/threed/scatter/demo/camera-animation.ts
--------------------------------------------------------------------------------
...
const ThreedScatterCameraAnimationChart: React.FC = () => {
  ...
  return (
     <div>
        ...
        <h2 className="text-xl font-semibold mb-2">Camera animation</h2>
...
export default ThreedScatterCameraAnimationChart;
