...
/*
Original Dumi Example Code from: ../../G2/site/examples/intelligent/auto/demo/auto-interval.ts
--------------------------------------------------------------------------------
// /**
...
const IntelligentAutoAutoIntervalChart: React.FC = () => {
  ...
  return (
     <div>
        ...
        <h2 className="text-xl font-semibold mb-2">Auto interval</h2>
...
export default IntelligentAutoAutoIntervalChart;
