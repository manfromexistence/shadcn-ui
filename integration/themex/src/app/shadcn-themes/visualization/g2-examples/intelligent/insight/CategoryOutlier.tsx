...
/*
Original Dumi Example Code from: ../../G2/site/examples/intelligent/insight/demo/category-outlier.ts
--------------------------------------------------------------------------------
// /**
...
const IntelligentInsightCategoryOutlierChart: React.FC = () => {
  ...
  return (
     <div>
        ...
        <h2 className="text-xl font-semibold mb-2">Category outlier</h2>
