...
/*
Original Dumi Example Code from: ../../G2/site/examples/graph/network/demo/forceGraph-disjoint.ts
--------------------------------------------------------------------------------
...
const GraphNetworkForceGraphDisjointChart: React.FC = () => {
  ...
  return (
     <div>
        ...
        <h2 className="text-xl font-semibold mb-2">ForceGraph disjoint</h2>
