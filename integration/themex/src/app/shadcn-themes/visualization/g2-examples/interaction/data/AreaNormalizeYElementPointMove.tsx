...
/*
Original Dumi Example Code from: ../../G2/site/examples/interaction/data/demo/area-normalizeY-element-point-move.ts
--------------------------------------------------------------------------------
...
const InteractionDataAreaNormalizeYElementPointMoveChart: React.FC = () => {
  ...
  return (
     <div>
        ...
        <h2 className="text-xl font-semibold mb-2">Area normalizeY element point move</h2>
