...
/*
Original Dumi Example Code from: ../../G2/site/examples/interaction/data/demo/line-element-point-move-polar.ts
--------------------------------------------------------------------------------
...
const InteractionDataLineElementPointMovePolarChart: React.FC = () => {
  ...
  return (
     <div>
        ...
        <h2 className="text-xl font-semibold mb-2">Line element point move polar</h2>
